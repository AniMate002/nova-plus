    ...
    return (
        <div className="w-[70%]">
            <Swiper slidesPerView={1.3} spaceBetween={20} className='w-full' freeMode={{sticky: false}} autoplay={{delay:2000}} modules={[Autoplay]} speed={1500}>
                <SwiperSlide >
                    <div className='teal--quote bg-teal-700 w-[700px] cursor-pointer p-14'>
                        <p className='text-black font-bold uppercase text-4xl Haptik'>Every design choice we make is a step toward pushing the boundaries of what gaming can achieve, and that's what excites me every day.</p>
                        <p className='text-white tracking-wider Haptik mt-6'>Lena Chen - Lead Game Designer at Nova Plus</p>
                    </div>
                </SwiperSlide>
                <SwiperSlide >
