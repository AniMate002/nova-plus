    ...
    return (
        ...
        <div className="px-10 py-10 w-full">
            ...
            <div className="flex flex-col items-end w-full text-white font-semibold tracking-widest gap-4 text-4xl mt-28">
                <Link onClick={closeHeaderSmall} to={'/games'} className="block h-[40px] overflow-hidden"><p className="link--header--small relative top-9">Games</p></Link>
                <Link onClick={closeHeaderSmall} to={'/news'} className="block sm:h-[40px] text-end vsm:h-[80px] overflow-hidden"><p className="link--header--small relative top-9 ">News</p></Link>
                <Link onClick={closeHeaderSmall} to={'/career'} className="block h-[40px] overflow-hidden"><p className="link--header--small relative top-9">Career</p></Link>
                <Link onClick={closeHeaderSmall} to={'/aboutUs'} className="block h-[40px] overflow-hidden"><p className="link--header--small relative top-9">About Us</p></Link>
            </div>
        </div>
