...
export const allBenefits: benefitsType = [
    {id:1, icon: 'fa-solid fa-rocket', title: 'Innovation Hub', description: 'NovaPlus provides a dynamic and creative workspace where innovation is not just encouraged but celebrated. Team members have the opportunity to work on cutting-edge projects that redefine the gaming industry.' },
    {id:2, icon: 'fa-solid fa-earth-americas', title: 'Global Reach', description: 'Join a team that creates games with a global impact. NovaPlus\'s work reaches audiences around the world, allowing employees to contribute to the immersive experiences of players across diverse cultures.' },
    {id:3, icon: 'fa-solid fa-rainbow', title: 'Inclusive Culture', description: 'NovaPlus fosters an inclusive culture where diversity is valued. Team members experience an environment that embraces different perspectives, creating a workplace that is both supportive and enriching.' },
    {id:4, icon: 'fa-solid fa-book', title: 'Continuous Learning', description: 'NovaPlus invests in the professional growth of its employees. Access to workshops, training programs, and industry events ensures that team members stay at the forefront of the rapidly evolving gaming landscape.' },
    {id:5, icon: 'fa-solid fa-hand-spock', title: 'Talent Recognition', description: 'Exceptional talent is recognized and celebrated at NovaPlus. Outstanding contributions are acknowledged, creating a culture where each team member\'s unique skills are valued and appreciated.' },
    {id:6, icon: 'fa-regular fa-handshake', title: 'Collaborative Dynamics', description: 'NovaPlus thrives on collaboration. Team members work seamlessly together, combining diverse skill sets to tackle challenges and create games that push the boundaries of interactive entertainment.' },
    {id:7, icon: 'fa-solid fa-scale-balanced', title: 'Work-Life Balance', description: 'NovaPlus understands the importance of work-life balance. Flexible work schedules and a supportive environment enable employees to maintain a healthy equilibrium between professional and personal life.' },
    {id:8, icon: 'fa-solid fa-wand-magic-sparkles', title: 'Networking Opportunities', description: 'Working at NovaPlus opens doors to a vast network of industry professionals. Employees have opportunities to connect, collaborate, and build relationships with experts and peers in the gaming community.' },
    {id:9, icon: 'fa-regular fa-lightbulb', title: 'Creative Freedom', description: 'NovaPlus empowers its team with creative freedom. Team members have the autonomy to explore innovative ideas, contributing to the development of games that stand out for their originality and creativity.' },
    {id:10, icon: 'fa-solid fa-coins', title: 'Recognition and Rewards', description: 'NovaPlus values and rewards achievements. Whether it\'s hitting project milestones or personal accomplishments, employees enjoy recognition and rewards that highlight their contributions to the company\'s success.' },
];
